...
const UserCard = () => {
  return (
    <div className="bg-white border border-gray-800 w-96 hover:shadow-none relative flex flex-col mx-auto shadow-lg m-5">
      <div className="profile w-full flex m-3 ml-4 text-black">
        ...
        <div className="title ml-3 font-bold flex flex-col">
          <div className="text-base">Sarah Lester</div>

          <div className="add font-semibold text-sm italic ">
            sarah.lester@gmail.com
          </div>
        </div>
      </div>
